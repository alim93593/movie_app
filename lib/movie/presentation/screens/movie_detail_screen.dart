      ...
      builder: (context,state){
        switch(state.movieRequestState){
                  ...
                  background: FadeIn(
                    ...
                    child: ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: ApiConstance.imageUrl(state.movieDetail!.backDropBath!),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
          ...
          case RequestState.error:
            return  Center(child: Text(state.movieDetailsmessage.toString()),);
        }
      },
    );
  }
          ...
          delegate: SliverChildBuilderDelegate(
              ...
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:recommendation.backdropPath!=null? ApiConstance.imageUrl(recommendation.backdropPath!):
                    "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTMUrNbq_oihNGM6BGINdnV2CKD7g9JOnrVr1NGrwfBqJn3kUt_",
